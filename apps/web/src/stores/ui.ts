 ...
 */
export type WorkflowAppPage = `opinion-idea` | `opinion-rewrite` | `opinion-distribution` | `opinion-loop` | `data` | `booklet-research` | `booklet-plan` | `booklet-writing` | `booklet-operation` | `booklet-loop` | `repo-idea` | `repo-plan` | `repo-build` | `repo-operation` | `repo-loop` | `creation` | `import` | `sync` | `distribution` | `stats`
